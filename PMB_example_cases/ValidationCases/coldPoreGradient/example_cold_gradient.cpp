...
std::vector<FoamProperties> createYZA()
{
    ...
    YZA_40PPI.porosity                  = porosity_function;
...
int main()
{
    ...
    std::vector<double> phis{1e-10};
    Cantera::vector_fp mdots{0.1*YZA_40PPI_porosity}; // initial guess for the FPF inlet mass flow
